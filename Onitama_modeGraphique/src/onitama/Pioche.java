 ...
 */
public class Pioche {
    Carte[] cartePioche = new Carte[16];  //On définit les déplacements possibles comme des vecteurs avec pour origine le point en haut à gauche de la grille
    public Pioche()  {                    // Le déplacement est donc définit par un couple (déplacement sur lignes, déplacement sur colonnes)
